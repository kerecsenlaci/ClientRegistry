...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2017. Okt 12. 09:19
...
(3, 'Gábor Bácsi', '068011111999', 'info@gabibacsi.hu', 4),
(8, 'Sás Pali', '708889011', 'pali@sas.hu', 4),
(9, 'Laci', '00000000', 'koizhdfgh', 0);
...
CREATE TABLE `parameters` (
  ...
  `ParameterValue` varchar(5) COLLATE utf8_hungarian_ci NOT NULL,
...
(3, 'SDC Bt', 1, 9, 2145, 'Hatvan', 'Ady E. u. 85', 3),
(4, 'BlaBlaCom Kft.', 1, 13, 1111, 'Debrecen', 'Árok u. 51', 3),
(5, 'Havas Imre ev.', 3, 13, 2145, 'Kerepes', 'Vas krt. 75', 8);
...
--
-- A tábla adatainak kiíratása `switch`
--

INSERT INTO `switch` (`ID`, `PartnerId`, `ContactId`) VALUES
(19, 5, 8),
(28, 3, 8),
(43, 4, 8),
(44, 4, 3),
...
(-1, 'Administrator', 'e3afed0047b08059d0fada10f400c1e5', 0),
(1, 'Kerecsen', '02c758bf69c8e228d37ca626297e21fd', 0),
(4, 'Laci', 'e3afed0047b08059d0fada10f400c1e5', 0),
(6, 'Gábor', 'e3afed0047b08059d0fada10f400c1e5', 0);
